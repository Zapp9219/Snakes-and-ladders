...
def TwoPlayerQuit(): #Quit protocol for 2 players
...
def TwoPlayerGame(): #Game routine for 2 players
        playerOneSpace = 0
        playerTwoSpace = 0
        move = 0
        ...
        while playerOneSpace < 30 and playerTwoSpace < 30: #Loops the roll mechanic when 30 hasn't been hit yet 
            move = random.randint(1,6) #Player 1 roll mechanic
            ...
            move2 = random.randint(1,6) #Player 2 roll mechanic
...
def ThreePlayerQuit(): #Quit protocol for 3 players
    Exit = input("would you like to exit now? Y/N \n")
    Exit = Exit.upper()
    if Exit == "Y":
        exit()
...
def ThreePlayerGame(): #Game routine for 3 players
        playerOneSpace = 0
        playerTwoSpace = 0
        playerThreeSpace = 0
        move = 0
...
Number = "0" #Gets the number of people are playing
...
if Number == "2": #Gets the names of the players
    ...
    while rollone == rolltwo: #First player mechanic
